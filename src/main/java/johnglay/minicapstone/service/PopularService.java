...
import johnglay.minicapstone.dto.PopularDTO;
import johnglay.minicapstone.entity.PopularEntity;
import johnglay.minicapstone.exception.UserAlreadyExist;
import johnglay.minicapstone.model.PopularRequest;
import johnglay.minicapstone.repository.PopularRepository;
...
public class PopularService {
    ...
    public List<PopularDTO> uploadProductImage(UUID productId, MultipartFile file) {
        ...
        String path = String.format("%s/%s", "minicapstone-jeff/minicapstone/john/popular-products", productId);
