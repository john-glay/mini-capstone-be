...
import johnglay.minicapstone.dto.BlogDTO;
import johnglay.minicapstone.entity.BlogEntity;
import johnglay.minicapstone.exception.UserAlreadyExist;
import johnglay.minicapstone.model.BlogRequest;
import johnglay.minicapstone.repository.BlogRepository;
...
public class BlogService {
    ...
    public List<BlogDTO> uploadBlogImage(UUID blogId, MultipartFile file) {
        ...
        String path = String.format("%s/%s", "minicapstone-jeff/minicapstone/john/blogs", blogId);
